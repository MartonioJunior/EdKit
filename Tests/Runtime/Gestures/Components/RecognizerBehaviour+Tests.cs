...
namespace Tests.MartonioJunior.EdKit
{
    ...
    public partial class RecognizerBehaviour_Tests
    {
        ...
        public static IEnumerable Register_PlacementTimePoses_UseCases()
        {
            ...
            yield return new TestCaseData(new Placement(), 0.0f, new List<IPose> { new Pose("Pose 1", p => 1.0f), new Pose("Pose 2", p => 0.2f) }, new PoseEvent(new Placement(), new Pose("Pose 1", p => 1.0f), 0.0f));
        }
